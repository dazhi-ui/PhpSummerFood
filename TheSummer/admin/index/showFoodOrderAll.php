    ...
    <div id="products_style">
        <div class="table_menu_list" id="testIframe" >
            <table class="table table-striped table-bordered table-hover" id="sample-table">
                ...
                $sqlatrwen="select * from user where username='".$username."'";
                $resultwen=mysqli_query($register,$sqlatrwen);
                $rowswen=mysqli_fetch_row($resultwen);
                //查询该用户订单
                $sqlstr2 = "select * from foodorder where userid='".$rowswen[0]."'order by id asc";
...
<script type="text/javascript">
    ...
    function member_del(obj,id,theid){
        layer.confirm('确认退款并删除订单吗？',function(index){
            //数据库删除操作
            $.ajax({
            ...
            layer.msg('退款成功，订单已删除!',{icon:1,time:1000});
        });
    }
